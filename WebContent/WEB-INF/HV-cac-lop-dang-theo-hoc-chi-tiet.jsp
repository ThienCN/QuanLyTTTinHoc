...
<head>
	...
	<!--MY JS -->
	<script src="./JS/HV-cac-lop-dang-theo-hoc-chi-tiet.js"></script>
</head>
<body>
    <!-- HEADER MENU -->
    <header>
            ...
            <div class="container">
                <div class="navbar-header">
                    ...
                    <div class="navbar-brand">
                        <a href="HV-cac-lop-dang-theo-hoc.html"><i class="fa fa-wpforms"></i><span class="page-trich-dan" id="tenlop"> CÁC LỚP ĐANG THEO HỌC</span> </a>
                    </div>
                </div>
    ...
    <section class="phan-noi-dung">
        <h1 id="khoahoc" style="font-weight: bold;color:#197485;"></h1>
        <hr />
        <h3><strong style="margin-left: 20px;">Tài liệu môn học:</strong></h3>
        <ul id="danh-sach-tai-lieu" style="font-size:20px;padding-left:65px;list-style-type: none">
        </ul>
    </section>
</body>
</html>