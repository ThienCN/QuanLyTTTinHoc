...
<head>
	...
	<!--MY JS -->
	<script src="./JS/GV-thong-tin-ca-nhan.js"></script>
</head>
<body>
    <!-- HEADER MENU -->
    <header>
        ...
        <nav class="navbar-default nav-menu">
            <div id="nav-left" class="navbar-collapse collapse">
                <ul class="nav">
                    ...
                    <li class="active"><a href="GV_thongtincanhan"><i class="fa fa-user-circle-o"></i> Thông tin cá nhân</a></li>
    ...
    <section class="phan-noi-dung">
        <div class="row">
            ...
            <div class="col-lg-7 col-sm-7 col-md-7 col-xs-12" style="line-height:40px">
                <h3 class="thong-tin-hoc-vien">THÔNG TIN GIÁO VIÊN</h3>
                ...
                <div id="TDHV" class="col-lg-6 col-sm-6 col-md-6 col-xs-7" style="color:#197485">
                    <span style="color:black">: </span>
                </div>
                <div class="col-lg-6 col-sm-6 col-md-6 col-xs-5">
                    SĐT
