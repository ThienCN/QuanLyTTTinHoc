...
<head>
    ...
    <!-- MY JS -->
	<script src="./JS/NV_quanlytintuc.js"></script>
            ...
            <div class="container">
                <div class="navbar-header">
                    ...
                    <div class="navbar-brand">
                        <a href=NV_quanlytintuc><i class="glyphicon glyphicon-globe"></i><span class="page-trich-dan"> QUẢN LÝ TIN TỨC</span> </a>  
                    </div>
                </div>
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-6 col-md-6">
                <div class="form-group" style="float:right">
                    <a href="NV_themtintuc" class="btn btn-default" style="background-color: #197485; color:white; width: 280px;">
