...
<head>
    ...
    <!--MY JS-->
    <script src="./JS/NV_themthongbao.js"></script>
</head>
<body>
	<!-- HEADER MENU -->
    <header> 
            ...
            <div class="container">
                <div class="navbar-header">
                    ...
                    <div class="navbar-brand">
                        <a href="NV_themthongbao">
	                        <i class="glyphicon glyphicon-globe"></i>
	                        <span class="page-trich-dan">TẠO THÔNG BÁO</span> 
                        </a>  
                    </div>
                </div>
            ...
            <div class="w3-twothird">
                <div class="form-horizontal">
                    <div class="form-group">
                        ...
                        <div class="col-xs-12 col-sm-9 col-md-9">
                            <input type="text" id="maThongBao" class="form-control" readonly>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-12 col-sm-9 col-md-9">
                            <textarea class="form-control" id="tomTatThongBao" rows="10" cols="50"></textarea>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-12 col-sm-9 col-md-9">
                            <input type="date" id="ngayThongBao" class="form-control"
                            <%
                       			Date date = new Date();                        			  
                ...
                <div class="form-group col-xs-9 col-sm-10 col-md-11">
                    <div class="input-group-btn" style="float:right">
                        <button id="luu-thong-bao" class="btn btn-default" style="background-color: #197485; color:white; width: 100px;">
