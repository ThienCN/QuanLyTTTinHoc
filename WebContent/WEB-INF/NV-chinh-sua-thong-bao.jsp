...
<head>
    ...
    <!--MY JS-->
    <script src="./JS/NV_chinhsuathongbao.js"></script>
    <style>
		#myImg {
		    border-radius: 5px;
		    cursor: pointer;
            ...
            <div class="container">
                <div class="navbar-header">
                    ...
                    <div class="navbar-brand">
                        <a href="NV_chinhsuathongbao">
	                        <i class="glyphicon glyphicon-globe"></i>
	                        <span class="page-trich-dan">CHỈNH SỬA THÔNG BÁO</span> 
                        </a>  
                    </div>
                </div>
            ...
            <div class="w3-twothird">
                <div class="form-horizontal">
                    <div class="form-group">
                        <label class="control-label col-xs-12 col-sm-3 col-md-3">Mã thông báo:</label>
                        <div class="col-xs-12 col-sm-9 col-md-9">
                            <input id="maThongBao" type="text" class="form-control" readonly>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-xs-12 col-sm-3 col-md-3">Tiêu đề thông báo:</label>
                        <div class="col-xs-12 col-sm-9 col-md-9">
                            <input type="text" id ="tieuDeThongBao" class="form-control">
                            <span id="error-tieuDeThongBao" style="color:red; font-size:8px"></span>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-xs-12 col-sm-3 col-md-3">Tóm tắt thông báo:</label>
                        <div class="col-xs-12 col-sm-9 col-md-9">
                            <textarea id="tomTatThongBao" class="form-control" rows="10" cols="50"></textarea>
                            <span id="error-tomTatThongBao" style="color:red; font-size:8px"></span>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-xs-12 col-sm-3 col-md-3">Ngày thông báo:</label>
                        <div class="col-xs-12 col-sm-9 col-md-9">
                            <input id="ngayThongBao" type="date" class="form-control">
                            <span id="error-ngayThongBao" style="color:red; font-size:8px"></span>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-xs-12 col-sm-9 col-md-9" style="padding-top: 3px; margin-bottom: 0;">
                        	...
                        	<form id="hinhAnhTBMoi" class="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label class="control-label col-xs-12 col-sm-3 col-md-3">Tệp đính kèm:</label>
                        <div class="col-xs-12 col-sm-9 col-md-9" style="padding-top: 3px; margin-bottom: 0;">
                        	<a id="tenFile"></a> 
                        	<form id="tepDinhKemTBMoi" class="form-horizontal" enctype="multipart/form-data">
								<div class="input-group">
									<input id="tepDinhKem" type="file" name="tepDinhKem" /> 
                ...
                <div class="form-group col-xs-9 col-sm-10 col-md-11">
                    <div class="input-group-btn" style="float:right">
                        <button id="luu-thong-bao" class="btn btn-default" style="background-color: #197485; color:white; width: 100px;z-index: 0">
