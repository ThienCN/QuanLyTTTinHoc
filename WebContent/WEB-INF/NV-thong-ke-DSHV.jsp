...
<head>
	...
	<title>Thống kê danh sách học viên</title>
    ...
    <!-- MY JS -->
    <script src="./JS/NV-thong-ke-DSHV.js"></script>
    <!-- MY CSS -->
...
<body>
                ...
                <div class="navbar-header">
                    ...
                    <div class="navbar-brand">
                        <a href="NV_thongkeDSHV">
	                        ...
	                        <span class="page-trich-dan">THỐNG KÊ DANH SÁCH HỌC VIÊN</span> 
                      	</a>  
                    </div>
                </div>
        ...
        <nav class="navbar-default nav-menu">
            <div id="nav-left" class="navbar-collapse collapse">
                <ul class="nav">
                    ...
                    <li class="active"><a href="NV_thongkeDSHV"><i class="glyphicon glyphicon-list-alt"></i> Thống kê DS Học viên</a></li>
    ...
    <section class="phan-noi-dung">
        ...
        <div class="row">
            <div class="col-xs-12 col-md-6">
                ...
                <div class="input-group-btn" style="text-align: right">
                    <button id="btn-thong-ke-ds-hoc-vien" class="btn btn-default" type="submit" style="background-color: #197485; color:white; width:150px; ">
        ...
        <fieldset id="ket-qua-thong-ke"  style="display:none">  
            ...
            <p style="font-weight: bold;">Số lượng: <span id="soLuong" style="color:red">0</span> học viên</p>
            <div class="table-responsive">
                <table class="table" id="table-ds-hoc-vien">
                    <thead>
                        <tr>
                        	<th>STT</th>
                            <th>Mã học viên </th>
            ...
            <br />
            <div class="input-group-btn" style="text-align: right">
                <button id="btn-xuat-file-HocVien" class="btn btn-default" type="submit" style="background-color: #197485; color:white; width:130px; ">
