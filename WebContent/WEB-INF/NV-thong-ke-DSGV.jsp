...
<head>
	...
	<title>Thống kê danh sách Giáo viên</title>
    ...
    <!-- MY JS -->
    <script src="./JS/NV-thong-ke-DSGV.js"></script>
    <!-- MY CSS -->
...
<body>
                ...
                <div class="navbar-header">
                    ...
                    <div class="navbar-brand">
                        <a href="NV_thongkeDSGV">
                        	...
                        	<span class="page-trich-dan">THỐNG KÊ DANH SÁCH GIÁO VIÊN</span> 
                        </a>  
                    </div>
                </div>
        ...
        <nav class="navbar-default nav-menu">
            <div id="nav-left" class="navbar-collapse collapse">
                <ul class="nav">
                    ...
                    <li class="active"><a href="NV_thongkeDSGV"><i class="glyphicon glyphicon-list-alt"></i> Thống kê DS Giáo viên</a></li>
    ...
    <section class="phan-noi-dung">
            ...
            <div class="col-xs-12 col-md-6">
                <div class="input-group">
                    ...
                    <div class="input-group-btn" style="text-align: right">
                        <button id="btn-thong-ke-ds-Giao-Vien" class="btn btn-default" style="background-color: #197485; color:white; width:150px; ">
        ...
        <fieldset id="ket-qua-thong-ke" style="display:none">
            ...
            <br />
             <div class="input-group-btn" style="text-align: right">
                <button id="btn-xuat-file-GiaoVien" class="btn btn-default" type="submit" style="background-color: #197485; color:white; width:130px; ">
